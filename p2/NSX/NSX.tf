...
resource "nsxt_policy_segment" "seg12" {
  display_name        = "seg12"
...
resource "nsxt_policy_segment" "seg13" {
  display_name        = "seg13"
  description         = "Terraform provisioned Segment"
  connectivity_path   = "/infra/tier-1s/cgw"
  transport_zone_path = data.nsxt_policy_transport_zone.TZ.path
...
output "segment12_name"     {value = nsxt_policy_segment.seg12.display_name}
output "segment13_name"     {value = nsxt_policy_segment.seg13.display_name}
